...
function buildMeterPerfTableHTML(m, bills, incl, opts) {
  ...
  postRows.forEach(function (r) {
    ...
    // which never carry a gas/propane rate and always show a dash here by design. Flagging
    // every water/sewer bill would be noise outside this item's gas/electric scope.
