        ...
        scales: {
          x: {
            ...
            title: {
              display: true,
              text: 'kBtu/ft²/yr',
              color: isInteractive ? 'rgba(200,210,230,0.6)' : '#333',
              font: { size: 10 },
            },
            ticks: {
              color: isInteractive ? 'rgba(200,210,230,0.6)' : '#333',
            ...
            grid: {
              display: true,
              color: isInteractive ? 'rgba(200,210,230,0.08)' : 'rgba(0,0,0,0.1)',
            },
          },
          y: {
            ticks: {
