...
var RELEASE_NOTES = [
  ...
  },
  {
    ...
    items: [
      { type: 'feature', text: 'Cost Estimate: added an Audit Estimate section with hours and cost for a Building Automation System Audit or a Full Facility Audit, computed from the Equipment Matrix, plus buttons to generate a client-facing Audit Proposal document. Equipment Matrix: fixed equipment type detection so exterior lighting relays, a leak sensor, and a glycol feed system show their real equipment type instead of Other. Bill PDF import: WoodRiver Energy site tabs now show (needs review) whenever a bill has a real missing field, no matter which label the tab shows.' },
    ],
  },
  {
    v: 'v2026.09.25.12',
  ...
  },
  {
    ...
    items: [
      { type: 'fix', text: 'Utility Data / Review Bill Corrections and WoodRiver Energy PDF review: proposed values now show at printed precision instead of raw floats, plain-language wording replaces OCR jargon, missing account/meter numbers are omitted instead of showing a placeholder, WoodRiver customer-number and MMBtu labels display correctly, every WoodRiver site tab now agrees with the panel\'s own field check, and the bill-PDF-not-found message is now plain text.' },
    ],
  },
  {
    v: 'v2026.09.25.7',
  ...
  },
  {
    ...
    items: [
      { type: 'feature', text: 'Utility Data: new Review Bill Corrections button re-checks saved bills against the corrected bill-reading rules and lets you apply the corrections you tick.' },
    ],
  },
  {
    v: 'v2026.09.24.19',
