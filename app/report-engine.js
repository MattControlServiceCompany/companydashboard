      ...
      function collectReportData(projId, buildingIds, reportDateStr, reportType) {
        ...
        allBldgMeters.forEach(({ b, m, bills }) => {
          (bills || []).forEach((bill) => {
            var _billYm =
              normMonth(bill.start, bill.end, m.inclusive !== false, bills) ||
              (bill.start ? bill.start.substring(0, 7) : '');
        ...
        const footerLabelHtml =
          data && data.period
            ? '<div style="text-align:center;font-size:8px;color:#888;padding:4px 0 2px;position:absolute;bottom:' +
              ...
              ' ' +
              (data.period.type === 'quarterly' ? 'Quarterly' : 'Annual') +
              ' Report</div>'
            : '';
            ...
            if (bResult.meterPerfHTML) {
              _mpBlocks.push(
                '<div style="page-break-inside:avoid;break-inside:avoid;margin-bottom:10px">' +
                  '<div style="font-size:10px;font-weight:700;color:#1a5276;margin-bottom:3px;border-bottom:1px solid #d4e4f0;padding-bottom:2px">' +
                  (b.name || 'Building') +
                  '</div>' +
      ...
      function rptPageCover(n, d) {
        ...
        const aheadLabel =
          ahead >= 0
            ? $c(ahead) + ' ahead of quarterly projection'
            : $c(Math.abs(ahead)) + ' behind quarterly projection';
            ...
            const statusIcon =
              b.status === 'on_track'
                ...
                : b.status === 'near_target'
                  ? '&#9658; Near Target'
                  : '&#9658; Below Target';
            const cardStyle = b.status === 'below_target' ? 'background:#fdf0f0;border-color:#f5a9a9;' : '';
        ...
        const bodyHTML =
          ...
          '<div style="font-size:9px;font-weight:700;color:#1a5276;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;">Portfolio Metrics</div>' +
          ...
          '<div style="margin-top:6px">' +
          '<div style="font-size:9px;font-weight:700;color:#1a5276;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;">Building Status</div>' +
          ...
          // Key Findings
          '<div style="margin-top:6px;">' +
          '<div style="font-size:9px;font-weight:700;color:#1a5276;text-transform:uppercase;letter-spacing:0.5px;margin-bottom:4px;">Key Findings</div>' +
          findingsHTML +
          '</div>' +
          '</div>';
      ...
      function rptPageFinancial(n, d) {
        ...
        const bldgTable =
          '<table class="rpt-table" contenteditable="false" style="font-size:8px;width:100%;table-layout:fixed">' +
        ...
        const qtrRow =
          ...
          '</tr>';
        const qtrTable =
          '<table class="rpt-table" contenteditable="false" style="font-size:7.5px;width:100%;table-layout:fixed">' +
          '<thead><tr style="text-align:center;white-space:normal;word-wrap:break-word;line-height:1.2">' +
        ...
        const cumulativeSVG =
          ...
          (actLinePts.length > 1
            ? '<path d="' + actLinePath + '" fill="none" stroke="#27ae60" stroke-width="2.5"/>'
            : '') +
          (actLinePts.length > 1
            ? '<circle cx="' +
              (padL + (curQtr / totalQtrs) * cW).toFixed(1) +
        ...
        const bodyHTML =
          ...
          (function () {
            ...
            _rows +=
              ...
              '</td></tr>';
            return (
              '<h2>Monthly Cost Breakdown</h2><table class="rpt-table" style="font-size:8px"><thead><tr><th>Month</th><th class="rpt-n">Baseline Cost</th><th class="rpt-n">Actual Cost</th></tr></thead><tbody>' +
              _rows +
              '</tbody></table>'
            );
          })() +
      ...
      function rptPageSavingsPerformance(n, d) {
        ...
        let chartSection = '';
        {
          ...
          chartSection =
            ...
            '<div style="display:flex;gap:12px;margin-bottom:4px;font-size:7px">' +
        ...
        const bldgRows = d.buildings
          .map(function (b, bIdx) {
            ...
            return (
              ...
              rowBg +
              '">' +
              '<td style="font-weight:600;vertical-align:middle;font-size:7px;' +
              rowBg +
              '" contenteditable="true">' +
              (b.name || '—') +
              '</td>' +
        ...
        const bldgTable =
          '<table class="rpt-table" contenteditable="true" style="font-size:8px">' +
          '<thead><tr>' +
          '<th>Building</th>' +
          '<th>Year</th>' +
          ...
          .map(function (b) {
            ...
            return (
              ...
              (bl > 0
                ...
                : '') +
              '</div>' +
              '<div style="width:35px;font-size:7px;font-weight:600;color:#333;flex-shrink:0">' +
              (cur > 0 ? cur.toFixed(1) : '—') +
              '</div>' +
              '</div>'
            );
      ...
      function rptPageEnvironmentalImpact(n, d) {
        var _annualize =
          d.reportOptions && d.reportOptions.annualizePollution && d.period && d.period.type === 'quarterly';
        ...
        function polLine(val, unit, label) {
          ...
          return (
            '<div style="font-size:11px;color:#333;padding:2px 0;line-height:1.5;text-align:center">' +
            '<strong style="color:#1a5276;font-size:13px">' +
            $n(val) +
            '</strong>' +
            ' total ' +
            unit +
        ...
        function eqLine(prefix, val, suffix) {
          ...
          return (
            '<div style="font-size:11px;color:#333;padding:2px 0;line-height:1.5;text-align:center">' +
            (prefix ? prefix + ' ' : '') +
            '<strong style="color:#1e8449;font-size:13px">' +
            $n(val) +
            '</strong>' +
            ' ' +
            suffix +
        ...
        const bodyHTML =
          ...
          '<div style="font-size:11px;font-weight:700;color:#1a5276;text-transform:uppercase;letter-spacing:0.04em;margin-bottom:8px;border-bottom:1px solid #d4e4f0;padding-bottom:4px">Pollutants Avoided</div>' +
          polLines +
          '</div>' +
          '<div style="padding:4px 0;text-align:center">' +
          '<div style="font-size:11px;font-weight:700;color:#1e6b3a;text-transform:uppercase;letter-spacing:0.04em;margin-bottom:8px;border-bottom:1px solid #b7dfc7;padding-bottom:4px">Real-World Equivalents</div>' +
          eqLines +
          '</div>' +
          '</div>' +
      ...
      function rptPageObservations(n, d) {
        ...
        const bldgSections = (d.buildings || [])
          .map(function (b) {
            const statusColor =
              b.status === 'on_track' ? '#27ae60' : b.status === 'near_target' ? '#e67e22' : '#c0392b';
            ...
            return (
              '<h3 contenteditable="true" style="font-size:12px;font-weight:700;color:' +
              statusColor +
              ';margin:10px 0 2px">' +
              arrow +
              ' ' +
        ...
        const bodyHTML =
          ...
          '<div style="font-size:12px;line-height:1.6;margin-bottom:8px" contenteditable="true">' +
          summaryPara +
          '</div>' +
          bldgSections +
      ...
      function rptPageContractProjection(n, d) {
        ...
        const vsBox =
          ...
          ' Savings</div>' +
          '</div>' +
          '<div class="rpt-vs-mid" style="font-size:28px">' +
          (ahead ? '✓' : '✗') +
          '</div>' +
          '<div class="rpt-vs-side">' +
        ...
        var svgChart =
          ...
          '<text x="' +
          (padL + cW - 108) +
          '" y="10" font-size="6" fill="#555">Projected/Qtr</text>' +
          '<line x1="' +
          (padL + cW - 50) +
          '" y1="7" x2="' +
          (padL + cW - 38) +
          ...
          '<text x="' +
          (padL + cW - 34) +
          '" y="10" font-size="6" fill="#555">Actual</text>' +
          '</svg></div>';
      ...
      function rptPageSetPoints(n, d) {
        ...
        if (!setpoints || setpoints.length === 0) {
            ...
            if (useAvg && zones.length) {
              ...
              zones.forEach(function (z) {
                allRows +=
                  ...
                  (hasUnoccHeat
                    ? '<td class="rpt-n" contenteditable="true">' +
                      (z.unoccHeat != null ? z.unoccHeat + '°F' : '—') +
                      '</td>'
                    : '') +
                  (hasUnoccCool
                    ? '<td class="rpt-n" contenteditable="true">' +
                      (z.unoccCool != null ? z.unoccCool + '°F' : '—') +
                      '</td>'
                    : '') +
          ...
          if (!allRows) {
            allRows =
              '<tr><td colspan="' + colCount + '" style="color:#aaa;font-style:italic">No zones recorded</td></tr>';
          }
          bodyContent =
            '<table class="rpt-table" contenteditable="true">' +
            '<thead><tr>' +
      ...
      function rptPageBuildingSummary(n, d, b) {
        ...
        function buildBarChart(monthly, blColor, curColor, unit) {
          ...
          var maxH = 56; // px — maximum bar height
        ...
        // Building name
        var leftHTML =
          '<div contenteditable="true" style="font-size:15px;font-weight:700;color:#1a5276;line-height:1.2;margin-bottom:4px">' +
          (b.name || 'Building') +
          '</div>';
        ...
        leftHTML +=
          '<div style="font-size:9.5px;font-weight:600;color:#333;margin-bottom:6px;text-transform:uppercase;letter-spacing:0.03em">EUI (kBtu/sq ft/yr)</div>' +
        ...
        if (hasElec) {
          ...
          iconItems +=
            ...
            '<div style="font-size:13px;margin-bottom:1px">⚡</div>' +
        ...
        if (hasElec) {
          ...
          rightHTML +=
            '<div style="text-align:center;font-size:9.5px;font-weight:600;color:#1a5276;margin:6px 0 2px">' +
        ...
        if (hasGas) {
          ...
          rightHTML +=
            '<div style="text-align:center;font-size:9.5px;font-weight:600;color:#8b4513;margin:6px 0 2px">' +
        ...
        if (hasPropane) {
          ...
          rightHTML +=
            '<div style="text-align:center;font-size:9.5px;font-weight:600;color:#7d5a00;margin:6px 0 2px">' +
            'Propane Consumption' +
            '</div>' +
            '<div style="display:flex;justify-content:center">' +
            propChart +
                ...
                meter.commodity === 'Electric'
                  ...
                  : meter.commodity === 'Gas'
                    ...
                    : meter.commodity === 'Propane'
                      ...
                      : meter.commodity;
              var commColor =
                meter.commodity === 'Electric' ? '#1a5276' : meter.commodity === 'Gas' ? '#8b4513' : '#7d5a00';
              meterPerfHTML +=
        ...
        if (meterPerfHTML) {
          meterPerfHTML =
            '<div style="margin-top:8px"><div style="font-size:9.5px;font-weight:600;color:#1a5276;margin-bottom:3px">Meter Performance — ' +
            ((d && d.period && d.period.label) || '') +
            '</div>' +
            meterPerfHTML +
            '</div>';
      ...
      function rptPageElectric(n, d) {
        ...
        function buildElecBarChart(monthly, blColor, curColor, unit, title) {
          if (!monthly || !monthly.length)
            return '<p style="font-size:8px;color:#aaa;padding:4px 0">No monthly data</p>';
          var allVals = [];
          monthly.forEach(function (mo) {
            allVals.push(mo.bl || 0, mo.cur || 0);
          });
        ...
        var kwhChart = elecBldgs.length
          ...
          : '<p style="font-size:8px;color:#aaa">No electric data</p>';
        ...
        var bldgTable =
          '<table class="rpt-table" contenteditable="true" style="font-size:7.5px">' +
          '<thead><tr>' +
        ...
        var bodyHTML =
          ...
          kwhChart +
          kwChart +
          '<h2 style="font-size:10px;font-weight:700;color:#1a5276;margin:10px 0 4px">Electric by Building — ' +
          periodLabel +
          '</h2>' +
          bldgTable;
      ...
      function rptPageGas(n, d) {
        ...
        var thermsChart = gasBldgs.length
          ...
          : '<p style="font-size:8px;color:#aaa">No gas data</p>';
        ...
        if (!tableRows) {
          tableRows =
            '<tr><td colspan="8" style="color:#aaa;font-style:italic">No gas buildings in this project</td></tr>';
        } else {
        ...
        var bodyHTML =
          ...
          '</div>' +
          thermsChart +
          '<h2 style="font-size:10px;font-weight:700;color:#8b4513;margin:10px 0 4px">Natural Gas by Building — ' +
          periodLabel +
          '</h2>' +
          bldgTable;
      ...
      function rptPagePropane(n, d) {
        ...
        var galChart = propBldgs.length
          ...
          : '<p style="font-size:8px;color:#aaa">No propane data</p>';
        ...
        var bodyHTML =
          ...
          '</div>' +
          galChart +
          '<h2 style="font-size:10px;font-weight:700;color:#7d5a00;margin:10px 0 4px">Propane by Building — ' +
          periodLabel +
          '</h2>' +
          bldgTable +
          '<div style="margin-top:8px;font-size:8px;color:#777;font-style:italic;border-top:1px solid #ddd;padding-top:6px" contenteditable="true">' +
          noteText +
          '</div>';
      ...
      function rptPageGasPropane(n, d) {
        ...
        function _table(bldgs, getCom, unitLabel) {
          ...
          return (
            '<table class="rpt-table" contenteditable="true" style="font-size:7px"><thead><tr><th>Building</th><th class="rpt-n">Baseline ' +
            unitLabel +
        ...
        var bodyHTML =
          ...
          '<h2 style="font-size:9px;font-weight:700;color:#7d5a00;margin:8px 0 3px">Propane by Building</h2>' +
          _table(
            propBldgs,
            function (b) {
              return {
      ...
      function rptPageAppendixNormalization(n, d, appLetter) {
          ...
          var meterRows = details
            .map(function (md) {
              ...
              if (md.blStart && md.blEnd) {
                ...
                blPeriod =
                  monthNames[parseInt(s[1]) - 1] + ' ' + s[0] + ' – ' + monthNames[parseInt(e[1]) - 1] + ' ' + e[0];
              }
            ...
            .join('');
          meterTables +=
            '<div style="font-size:9px;font-weight:700;color:#1a5276;background:#e8f0f8;padding:4px 8px;border-radius:3px;margin:10px 0 4px">' +
            (b.name || 'Building') +
            '</div>' +
            '<table class="rpt-table" style="font-size:7.5px;margin-bottom:6px">' +
            '<thead><tr>' +
        ...
        if (!meterTables) {
          meterTables = '<p style="font-size:8px;color:#aaa;font-style:italic">No building meter data available.</p>';
        }

        var bodyHTML =
          '<h2 style="font-size:11px;font-weight:700;color:#333;margin:0 0 8px">Appendix ' +
          appLetter +
      ...
      function rptPageAppendixBaseline(n, d, appLetter, appMap) {
        ...
        (d.buildings || []).forEach(function (b) {
          ...
          calcHTML +=
            '<div style="font-size:10px;font-weight:700;color:#1a5276;background:#e8f0f8;padding:4px 8px;border-radius:3px;margin:10px 0 4px">' +
            (b.name || 'Building') +
            '</div>';
          ...
          metersWithCoeffs.forEach(function (md) {
            ...
            calcHTML +=
              ...
              md.r2 +
              ')</div>' +
              '<div style="font-family:monospace;font-size:8px;background:#f0f4f8;border:1px solid #d0dce8;border-radius:3px;padding:4px 8px;margin:2px 0 6px;color:#1a5276">' +
              eqn +
              '</div>' +
              '</div>';
            ...
            combined.forEach(function (entry) {
              ...
              if (entry.isBaseline) {
                ...
                rows +=
                  ...
                  '</td>' +
                  '<td style="font-family:monospace;font-size:6.5px;color:#bbb;white-space:nowrap">' +
                  formulaParts +
                  '</td>' +
            ...
            calcHTML +=
              '<table class="rpt-table" style="font-size:7px;margin-bottom:10px">' +
              '<thead><tr>' +
          ...
          metersWithBlOnly.forEach(function (md) {
            ...
            blMonthsForMeter.forEach(function (ym) {
              ...
              rows +=
                ...
                '</td>' +
                '<td style="font-size:7px;color:#bbb">—</td>' +
                '<td class="rpt-n" style="color:#bbb">—</td>' +
                '<td class="rpt-n" style="color:#bbb">—</td>' +
                '<td class="rpt-n" style="color:#bbb">—</td>' +
                '</tr>';
        ...
        if (!calcHTML) {
          calcHTML =
            '<p style="font-size:8px;color:#aaa;font-style:italic">No regression data available for calculation display.</p>';
        }
      ...
      function rptPageAppendixWeather(n, d, appLetter) {
        ...
        if (d.weather) {
          var pHDD =
            d.weather.totals && d.weather.totals.hddCur
              ? Math.round(d.weather.totals.hddCur).toLocaleString()
              : '\u2014';
          var bHDD =
          ...
          var hddPctChg =
            d.weather.totals && d.weather.totals.hddBl > 0
              ...
              : 0;
          var pCDD =
            d.weather.totals && d.weather.totals.cddCur
              ? Math.round(d.weather.totals.cddCur).toLocaleString()
              : '\u2014';
          var bCDD =
          ...
          var cddPctChg =
            d.weather.totals && d.weather.totals.cddBl > 0
              ...
              : 0;
          hddCddParagraph =
            '<div contenteditable="true" style="margin-top:10px;font-size:9px;color:#444;line-height:1.7">' +
            'Heating degree days (HDD) for the period were ' +
            pHDD +
            ' vs. a baseline average of ' +
            bHDD +
      ...
      function rptPageAppendixBills(n, d, appLetter) {
        ...
        (d.rawBills || []).forEach(function (bill) {
          var ym =
            normMonth(bill.start, bill.end, true, d.rawBills || []) || (bill.start ? bill.start.substring(0, 7) : '');
          if (billsByMonth[ym]) {
        ...
        var allBillImages = '';
        if (!periodYMs.length) {
          sections = '<p style="font-size:8px;color:#aaa;font-style:italic">No reporting period months configured.</p>';
        } else {
          periodYMs.forEach(function (ym) {
            var parts = ym.split('-');
            ...
            if (!bills.length) {
              rows =
                '<tr><td colspan="9" style="color:#aaa;font-style:italic">No bills recorded for this month</td></tr>';
            } else {
        ...
        var billImagesSection = allBillImages
          ? '<div style="margin-top:16px;border-top:1px solid #ddd;padding-top:10px">' +
            '<div style="font-size:9.5px;font-weight:700;color:#1a5276;margin-bottom:6px">Scanned Bill Images</div>' +
        ...
        var footerNote =
          '<div style="margin-top:12px;font-size:8px;color:#777;font-style:italic;border-top:1px solid #ddd;padding-top:6px">' +
          (_hasBillImages
      ...
      function openReportModal(projId, type) {
        ...
        REPORT_SECTIONS.forEach((sec) => {
          ...
          const isChecked =
            sec.key in savedSections
              ? savedSections[sec.key] === false
                ? ''
                : 'checked'
              : sec.defaultOff
                ? ''
        ...
        if (selectedSections.appendixD !== false && data.rawBills && data.rawBills.length) {
          ...
          for (var _bi = 0; _bi < _billsWithPdf.length; _bi++) {
            try {
              ...
              var _pdf = await pdfjsLib.getDocument({ data: _arr, useWorkerFetch: false, isEvalSupported: false })
                .promise;
      ...
      function _legacyGeneratePerformanceReport(projId, type, buildingIds, reportDateStr) {
        ...
        const bldgData = bldgs.map((b) => {
          ...
          bMeters.forEach(({ m, bills, incl, allRows, bl, blEnd, postRows }) => {
            ...
            if (
              hasDual &&
              regObj.dual.r2 > (hasHDD ? regObj.hdd.r2 : 0) &&
              regObj.dual.r2 > (hasCDD ? regObj.cdd.r2 : 0)
            ) {
              regrType = 'Dual (HDD + CDD)';
              r2 = regObj.dual.r2;
              slope =
                'HDD: ' + (regObj.dual.slopeHDD || 0).toFixed(4) + ', CDD: ' + (regObj.dual.slopeCDD || 0).toFixed(4);
            ...
            const blPeriodFmt = blSorted.length
              ? fmtYM(blSorted[0]) + ' - ' + fmtYM(blSorted[blSorted.length - 1])
              : '-';
            let blHDD = 0,
              blCDD = 0,
              blAnnCost = 0,
            ...
            meterDetails.push({
              meterName: [
                m.commodity,
                m.provider,
                m.account ? 'Account# ' + m.account : m.meter ? 'Meter# ' + m.meter : '',
              ]
                .filter(Boolean)
                .join(' - '),
              commodity: m.commodity,
        ...
        const rpMeterMonths = allBldgMeters.reduce(
          (s, x) => s + x.allRows.filter((r) => reportYMs.includes(r.ym)).length,
          0,
        );
        ...
        const boxes = [
          ...
          { label: 'Status', value: statusLabel, sub: '', color: statusColor },
          {
            ...
            sub: contractStart
              ? 'Started ' + monthNames[contractStart.getMonth()] + ' ' + contractStart.getFullYear()
              : '',
          },
          {
        ...
        allBldgMeters.forEach(({ m, bills, incl, allRows, bl, blEnd, postRows }) => {
          ...
          postRows.forEach((r) => {
            ...
            const calMo = parseInt(r.ym.split('-')[1]) - 1;
            const expUsage =
              blByCalMo[calMo] != null ? blByCalMo[calMo] : r.regrBaseline != null ? r.regrBaseline : blAvg;
            const actUsage = rawUsageByYm[r.ym] != null ? rawUsageByYm[r.ym] : r.usage;
        ...
        if (best && best.qtrSavings > 0 && bldgData.length > 1) {
          obs.push(
            'Top Performer: ' + best.name + ' led the project with ' + $c(best.qtrSavings) + ' in quarterly savings.',
          );
        }
          ...
          if (Math.abs(cddDiff) > 10) {
            obs.push(
              'Cooling Season: This period had ' +
                ...
                (useNormalized
                  ? 'Weather normalization accounts for this.'
                  : 'Actual comparison does not adjust for this.'),
            );
          }
        }
      ...
      function renderModalContacts() {
        ...
        if (!_modalContacts.length) {
          wrap.innerHTML =
            '<div class="cc-empty">No contacts yet — fill in the fields below and click + Add Contact.</div>';
          return;
        }
      ...
      function _fml(label, formula, result, sources) {
        ...
        h +=
          '<div style="font-family:var(--mono);color:var(--violet);font-size:13px;margin-bottom:4px">' +
          formula +
          '</div>';
        if (result != null)
          h +=
      ...
      document.addEventListener('click', (e) => {
        ...
        if (p && p.style.display === 'block' && b && !p.contains(e.target) && !b.contains(e.target))
