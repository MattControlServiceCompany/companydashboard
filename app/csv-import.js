...
const BILL_SCHEMA = {
  ...
  Gas: [
    ...
    { key: 'totalCost', label: 'Total Current Charges', type: 'currency', pdfKey: 'TotalCurrentCharges' },
    { key: '_wreTriggerCharge', label: 'WRE Trigger Charge', type: 'currency', pdfKey: '_wreTriggerCharge' },
    { key: '_wreTriggerMMbtu', label: 'WRE Trigger Usage (MMBtu)', type: 'number', pdfKey: '_wreTriggerMMbtu' },
    { key: '_wreTriggerRate', label: 'WRE Trigger $/MMBtu Rate', type: 'rate5', pdfKey: '_wreTriggerRate' },
    { key: '_wreIndexCharge', label: 'WRE Index (FOM) Charge', type: 'currency', pdfKey: '_wreIndexCharge' },
    { key: '_wreIndexMMbtu', label: 'WRE Index (FOM) Usage (MMBtu)', type: 'number', pdfKey: '_wreIndexMMbtu' },
    { key: '_wreIndexRate', label: 'WRE Index (FOM) $/MMBtu Rate', type: 'rate5', pdfKey: '_wreIndexRate' },
    { key: '_wreSWECharge', label: 'WRE Special Weather Event Charge', type: 'currency', pdfKey: '_wreSWECharge' },
    { section: 'Rates' },
